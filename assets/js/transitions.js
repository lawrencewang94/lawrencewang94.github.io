var HideShowTransition = Barba.BaseTransition.extend({
  ...
  finish: function() {
    ...
    Promise.all([pro1, pro2, pro3, pro4, pro5, pro6]).then(values => {
      // debugger
      ...
      var contactWidth = $(".contact").width(),
		...
		academicWidth = $(".academic").width(),
        academicHeight = $(".academic").height(),
		tradingWidth = $(".trading").width(),
  ...
  fadeIn: function() {
    Promise.all([this._newContainerPromise]).then(() => {
      ...
      if (this.newContainer.baseURI === window.location.origin + '/') {
		...
		$(".academic-border").css({ width: "100%" });
		$(".trading-border").css({ width: "100%" });
        ...
        var contactXPos = $(".contact").position().left,
          ...
          academicXPos = $(".academic").position().left,
          academicYPos = $(".academic").position().top,
		  tradingXPos = $(".trading").position().left,
          tradingYPos = $(".trading").position().top,
        ...
        var _this = this;
        var pros = [pro1, pro2, pro3, pro4, pro5, pro6];
        ...
        Promise.all(pros).then(() => {
		  ...
		  var proBorder5 = new Promise((resolve, reject) => {
            $(".academic-border").animate(
              {
                height: "0%"
              },
		   ...
		   var proBorder6 = new Promise((resolve, reject) => {
            $(".trading-border").animate(
              {
                height: "0%"
              },
          ...
          var borderPromises = [proBorder1, proBorder2, proBorder3, proBorder4, proBorder5, proBorder6];
